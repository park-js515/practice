...
(7788, 'SCOTT', 'ANALYST', 7566, STR_TO_DATE('13-JUL-87', '%d-%b-%y') - INTERVAL 85 DAY, 3000, NULL, 20),
...
(7876, 'ADAMS', 'CLERK', 7788, STR_TO_DATE('13-JUL-87', '%d-%b-%y') - INTERVAL 51 DAY, 1100, NULL, 20),
...
INSERT INTO t100 (ID)
SELECT seq
FROM (SELECT seq FROM seq_1_to_100) AS temp;
